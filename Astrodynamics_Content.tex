...
\begin{frame}{Slide Title with Figure}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{Low-Thrust-Info.png}
...
\begin{frame}{Synthesis & Industry Best Practices}
    \begin{itemize}
        ...
        \item \textbf{Industry Standard:} Engineers do not write their own solvers for deep space; they rely on established suites like GMAT (with CSALT), STK, or Copernicus. Your task is to audit the solution validity.
    \end{itemize}
\end{frame}
