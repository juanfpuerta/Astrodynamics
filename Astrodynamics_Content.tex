...
\begin{frame}{Section 1 Architecture and Operational Focus}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.85\textwidth]{Images/Low-Thrust-Info.png}
        \caption{This is a descriptive caption for my image.}
        \label{fig:low_thrust_arch} % Fixed duplicate label
    \end{figure}
\end{frame}
...
\begin{frame}{Side-by-Side Images}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Images/KF_Explanation.png}
        \end{column}
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Images/UdeA+simplificado+Negro_Smaller.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Slide Title with Figure}
    \begin{figure}
        ...
        \includegraphics[width=0.85\textwidth]{Images/Low-Thrust-Info.png}
        \caption{This is a descriptive caption for my image.}
        \label{fig:low_thrust_overview} % Fixed duplicate label
    \end{figure}
\end{frame}
